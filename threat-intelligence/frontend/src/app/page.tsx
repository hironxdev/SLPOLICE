        ...
        <div>
          <div className="flex items-center gap-3 mb-1">
            ...
            <h1 className="text-2xl font-black uppercase tracking-tighter">
              SL-CERT Intelligence
            </h1>
          </div>
          <p className="text-xs text-slate-500 font-bold uppercase tracking-widest ml-12">
            Cyber Operations Command • Openbird Cyber Security Enginnering CSEU
          </p>
        </div>
        ...
        <div className="xl:col-span-1 space-y-6">
          ...
          <div className="bg-blue-600/5 border border-blue-600/20 rounded-3xl p-6 relative">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-8 h-8 rounded-full bg-blue-600/20 flex items-center justify-center text-blue-500 font-bold italic">
                LK
              </div>
            ...
            <div className="flex-1 overflow-y-auto space-y-4 pr-2 custom-scrollbar">
              {attacks.slice(0, 10).map((attack) => (
                ...
                >
                  ...
                  ></div>
                  <div>
                    <p className="text-[10px] font-bold text-slate-200 group-hover:text-blue-400 transition-colors uppercase italic">
                      {attack.attack_type}
                    </p>
            ...
            {activeAlert && (
              <div className="absolute top-6 left-1/2 -translate-x-1/2 bg-rose-600/90 backdrop-blur-md px-8 py-4 rounded-2xl border border-rose-400 shadow-2xl flex items-center gap-4 animate-in fade-in slide-in-from-bottom-4">
                ...
                <div>
                  ...
                  <p className="text-[10px] font-bold text-rose-100 uppercase">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-[#0f172a] border border-slate-800 rounded-3xl p-8 flex items-center justify-between group hover:border-blue-600/50 transition-all">
              <div>
                ...
                <p className="text-[10px] text-slate-500 font-bold uppercase tracking-widest mt-1">
                  Detected via Global Nodes
                </p>
              </div>
              <span className="text-4xl font-black text-slate-800 group-hover:text-blue-600 transition-colors">
                412
              </span>
            </div>
            ...
            <div className="bg-[#0f172a] border border-slate-800 rounded-3xl p-8 flex items-center justify-between group hover:border-rose-600/50 transition-all">
              <div>
                ...
                <p className="text-[10px] text-slate-500 font-bold uppercase tracking-widest mt-1">
                  Attempts on Regional Hubs
                </p>
              </div>
              <span className="text-4xl font-black text-slate-800 group-hover:text-rose-600 transition-colors">
                1.2k
              </span>
            </div>
          </div>
